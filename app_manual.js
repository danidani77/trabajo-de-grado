...
function renderManual(){
  mainEl.innerHTML = `
    <section class="manual-hero">
      <h1>Notas de proceso, para quien siga con esto.</h1>
      <p>Aquí dejo lo que aprendí en el camino: los principios que seguí, los prompts que funcionaron tal cual, y los problemas técnicos que ya resolví, por si le sirven a quien continúe con estas piezas más adelante.</p>
...
function renderAutor(){
  mainEl.innerHTML = `
    <section class="autor-view reveal">
      <div class="autor-photo"><img src="${resolveAsset('assets/img/daniel.png')}" alt="Daniel Stiven Fabra Rodríguez"></div>
      ...
      <div class="hero-row" style="margin-top:32px;">
    ...
    <footer class="site-footer">Daniel Stiven Fabra Rodríguez · Diseño Gráfico · 2026 · ARUS → Henkia</footer>
  `;
  requestAnimationFrame(initReveal);
}
